        ...
        saveBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Log.w(TAG, "Failed to dismiss coord dialog", t);
                }
    ...
    private void saveExpense(@Nullable Double[] locPair, @Nullable Context fallbackCtx) {
        ...
        try {
            ...
            try {
                ...
                if (savedList != null) {
                    BudgetChecker.checkAndNotify(ctx, savedList);
                }
            } catch (Exception ex) {
                Log.w(TAG, "Budget check failed", ex);
            }
            ...
            new Handler(Looper.getMainLooper()).post(new Runnable() {
                ...
                public void run() {
                    try {
                        Toast.makeText(toastCtx, "Saved expense (#" + savedCount + ")", Toast.LENGTH_LONG).show();
                    } catch (Throwable t) {
            ...
            try {
                ...
                Log.w(TAG, "dismissAllowingStateLoss failed", t);
            }
        } catch (Exception ex) {
